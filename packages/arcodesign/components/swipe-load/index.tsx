    ...
    useEffect(() => {
        ...
        const touchmove = (e: TouchEvent) => {
            ...
            if (diff > 0 && scrollContainer.scrollLeft <= 1 && bounceWhenBumpBoundary) {
                ...
                setStyleWithVendor(bounceScrollContainer, 'transition', 'none');
                setStyleWithVendor(
                    bounceScrollContainer,
                    'transform',
                    `translateX(${bounceDistance}px) translateZ(0)`,
                );
            }
            ...
            if (showLoadMoreRef.current && diff < 0) {
                ...
                setStyleWithVendor(loadingCurrent, 'transition', 'all 0.02s');
                setStyleWithVendor(
                    loadingCurrent,
                    'transform',
                    `translateX(-${labelRightMargin}px) translateZ(0)`,
                );
                setStyleWithVendor(scrollContainer, 'transition', 'all 0.03s');
                setStyleWithVendor(
                    scrollContainer,
                    'transform',
        ...
        const touchend = () => {
            ...
            const resumeAnimation = () => {
                if (showLoadMoreRef.current) {
                    ...
                    setStyleWithVendor(scrollContainer, 'transition', scrollTransitionCssStyle);
                    setStyleWithVendor(scrollContainer, 'transform', scrollTransformCssStyle);
                    setStyleWithVendor(loadingCurrent, 'transition', scrollTransitionCssStyle);
                    setStyleWithVendor(loadingCurrent, 'transform', scrollTransformCssStyle);
                }
